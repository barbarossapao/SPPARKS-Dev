...
#ifdef APP_CLASS
AppStyle(mesodiffusion,AppMesoDiffusion)

#else

#ifndef SPK_APP_MESODIFFUSION_H
#define SPK_APP_MESODIFFUSION_H

#include "app_lattice.h"

namespace SPPARKS_NS {

class AppMesoDiffusion : public AppLattice {
  friend class DiagDiffusion;

 public:
  AppMesoDiffusion(class SPPARKS *, int, char **);
  ~AppMesoDiffusion();
  ...
  void site_event_rejection(int, class RandomPark *); // Not used 
 ...
 private:
  ...
  double D,a,gamma,Gamma;  // D: diffusion coeff.; a: site lattice constant; gamma: surface energy; Gamma: hopping rate derived from 4*D/a^2
